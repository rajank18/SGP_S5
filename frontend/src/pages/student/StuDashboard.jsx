    ...
    <div className="bg-gray-100 min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">My Project Groups</h1>
          <p className="text-gray-600">View and manage your assigned projects</p>
        </header>

        <div className="space-y-6">
          {projects.map((project) => (
            <div key={project.id} className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
              {/* Group Header */}
